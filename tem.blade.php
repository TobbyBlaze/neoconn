	...
	<div id="page-wrapper">
		<header id="header">
			<div id="logo" style="" class="default-logo">
				<a href="">
					<img src="connect.png" width="108" height="25" alt="{{config('app.name', 'CC')}}" />
				</a>
			</div>
			<nav id="nav" class="animated shake slow">
				<ul id="menu-header" class="menu">
					...
					<li id="menu-item-511" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-511"><a href="/newconn/public/home">Home<i class="fa fa-home"></i></a></li>
					<li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="/newconn/public/notification/{{Auth::user()->id}}" aria-current="page">Notifications<i class="fa fa-bell"></i><span class="badge badge-light"> {{auth()->user()->unReadNotifications->count()}} </span></a></li>
					...
					<li id="menu-item-475" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="/newconn/public/user/{{Auth::user()->id}}" aria-current="page">Profile<i class="fa fa-user"></i> </a></li>
				</ul>
				<div id="bp-buttons">
			...
			<nav id="mobile-nav" class="animated shake slow">
				...
				<ul class="menu">
					<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-511"><a href="/newconn/public/home">Home<i class="fa fa-home"></i></a></li>
					<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-223 current_page_item menu-item-475"><a href="/newconn/public/notification/{{Auth::user()->id}}" aria-current="page">Notifications<i class="fa fa-bell"></i><span class="badge badge-light"> {{auth()->user()->unReadNotifications->count()}} </span></a></li>
					...
					<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-476"><a href="/newconn/public/user/{{Auth::user()->id}}">Profile<i class="fa fa-user"></i></a></li>
				</ul>			
		...
		<div id="content-wrapper">
			...
			<aside id="sidebar-right" class="sidebar">
				<div id="gp-statistics-widget-5" class="widget gp-statistics">		
					<h3 class="widgettitle">{{auth()->user()->name}}'s Statistics<i class="fa fa-bar"></i></h3>		
				...
				<div id="bp_core_whos_online_widget-1" class="widget widget_bp_core_whos_online_widget buddypress widget">
					<h3 class="widgettitle">Who&#8217;s Online</h3>
		...
		<div id="footer-widgets">
			...
			<div class="footer-widget footer-4 footer-fourth">
				<div id="text-2" class="widget widget_text" style="background-color:black;">
					&nbsp <h3><a href="/newconn/public/about" class="widgettitle" style="color:white;">About Us</a></h3>
					<div class="textwidget"> </div>
				</div>
			</div>
			<div id="copyright" style="color:white;" class="animated shake slow">Copyright &copy; 2019 | <a href="" style="color:white;">{{ config('app.name', 'web') }}</a>. All rights reserved.</div>
		</div>
	</footer>
