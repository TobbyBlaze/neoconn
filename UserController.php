...
class UserController extends Controller
{
    ...
    public function viewProfile(int $profileId)
    {
        ...
        return view('user.profile', compact('user', 'users', 'followers' , 'followings', 'posts'), ['user' => $user])->with('posts', $posts)->with('user', $user)->with('users', $users)->with('comments', $comments)->with('followers', $followers)->with('followings', $followings);
        }else{
            return redirect()->back();
        }
